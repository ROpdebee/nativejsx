...
const safeOptions = (options) => {
  ...
  copy.acorn = Object.prototype.hasOwnProperty.call(copy, 'acorn')
    ? copy.acorn
    : {}
  copy.acorn.plugins = Object.prototype.hasOwnProperty.call(copy.acorn, 'plugins')
    ? copy.acorn.plugins
    : {}
 ...
 */
const transpile = nativejsx.transpile = (jsxSrc, options) => {
  ...
  const ast = acorn.Parser.extend(jsx()).parse(jsxSrc, safe.acorn)
